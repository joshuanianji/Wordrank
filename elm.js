...
var $author$project$View$InputString$dataTable = function (model) {
	var _v0 = model.inputContent.tupleList;
	if (_v0.$ === 'Nothing') {
		...
		_List_fromArray(
			[
					...
					]),
				{
					...
					spellcheck: false,
					text: function () {
						var _v0 = model.inputContent.text;
						if (_v0.$ === 'Nothing') {
							return '';
						} else {
							var string = _v0.a;
...
var $author$project$View$UploadFile$dataTable = function (model) {
	var _v0 = model.fileContent.tupleList;
	if (_v0.$ === 'Nothing') {
		return $mdgriffith$elm_ui$Element$none;
	} else {
		var list = _v0.a;
...
var $author$project$View$UploadFile$fileContentAttributes = function (model) {
	...
	var _v0 = model.fileContent.fileText;
	if (_v0.$ === 'Just') {
...
var $author$project$View$UploadFile$ifFileSelected = function (model) {
	var _v0 = model.fileContent.file;
	if (_v0.$ === 'Just') {
		var file = _v0.a;
		return A2(
			$mdgriffith$elm_ui$Element$column,
			...
			[
				...
				A2(
					...
					$author$project$GithubLogo$view(
						{bgColor: 'rgb(215, 215, 215)', bodyColor: 'rgb(51, 51, 61)', href: 'https://github.com/joshuanianji/HIIT-Timer'})))
			]),
		function () {
